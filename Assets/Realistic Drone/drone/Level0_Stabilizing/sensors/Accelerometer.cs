...
public class Accelerometer : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        LocalLinearVelocity = droneSettings.setZeroIflessThan(
            Quaternion.AngleAxis(45, transform.up) * transform.InverseTransformDirection(rb.linearVelocity),
            0.0001f);
        ...
        LV = droneSettings.setZeroIflessThan(rb.linearVelocity, 0.0001f);
